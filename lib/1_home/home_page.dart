...
//var for residential
  ...
  Future getData() async{
    var url=Uri.parse("https://diary.dnascholarship.ae/show/b");
    ...
    //items.clear();
      ...
      setState(() {
        for (int i=0; i<list1.length; i++){
          building_id.add(list1[i]["building_id"]);
  ...
  Future getDataland() async{
    var url=Uri.parse("https://diary.dnascholarship.ae/show/l");
    Response response= await get(url);
    ...
    //items.clear();
      ...
      setState(() {
        for (int i=0; i<list1.length; i++){
          land_id.add(list1[i]["sale_or_rent"]);
          land_typeitems.add(list1[i]["land_id"]);
  ...
  Future getDatastor() async{
    var url=Uri.parse("https://diary.dnascholarship.ae/show/s");
    Response response= await get(url);
  ...
  Future getDataresidential() async{
    var url=Uri.parse("https://diary.dnascholarship.ae/show/r");
    Response response= await get(url);
    ...
    //items.clear();
      ...
      setState(() {
        for (int i=0; i<list1.length; i++){
          residential_id.add(list1[i]["residential_id"]);
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      ListView.builder(
                          ...
                          scrollDirection: Axis.vertical,
                          shrinkWrap: true,
                          itemCount: residential_id.length,
                          itemBuilder: (BuildContext context, int index) {
